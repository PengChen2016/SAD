            ...
            for in_str=type
                ...
                if strcmp(in_str{1}(2),'a')
                    switch in_str{1}(1)
                        case 'r'
                            r=[0,45.5];
                            obj.ne_r=nonuniform_dist.get_ne_r(r);
                            obj.Te_r=nonuniform_dist.get_Te_r(r);
                        case 'z'
                            z=[-200,200];
                            obj.ne_z=nonuniform_dist.get_ne_z(z);
                            obj.Te_z=nonuniform_dist.get_Te_z(z);
                        otherwise
                            error('No such type!')
                    end
                    continue
                ...
                if isempty(idx)
                    ...
                    switch in_str{1}(1)
                        case 'r'
                            obj.ne_r=nonuniform_dist.get_ne_r(b);
                            obj.Te_r=nonuniform_dist.get_Te_r(b);
                        case 'z'
                            obj.ne_z=nonuniform_dist.get_ne_z(b);
                            obj.Te_z=nonuniform_dist.get_Te_z(b);
                        otherwise
                            error('No such type!')
                    end
                    continue
