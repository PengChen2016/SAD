...
h_fig=plot_nY(d2(plasma_t.p,1),'p [Pa]',...
    d2(plasma_t.ne,1),'ne, Pin=18kW',...
    d2(plasma_t.ne,2),'ne, Pin=36kW',...
    d2(plasma_t.ne,3),'ne, Pin=55kW',...
    'ne','plot');
h_fig=plot_nY(d2(plasma_t.p,1),'p [Pa]',...
    d2(plasma_t.Te,1),'Pin=18kW',...
    d2(plasma_t.Te,2),'Pin=36kW',...
    d2(plasma_t.Te,3),'Pin=55kW',...
    'Te','plot');
...
h_fig=plot_nY(d2(plasma_t.p,1),'p [Pa]',...
    ...
    'frequency [s^{-1}]','plot');
h_fig=plot_nY(d2(plasma_t.p,1),'p [Pa]',...
    d2(plasma_t.nu_enp,1),'enp, Pin=18kW',...
    d2(plasma_t.nu_enp,2),'enp, Pin=36kW',...
    d2(plasma_t.nu_enp,3),'enp, Pin=55kW',...
    d2(plasma_t.nu_eniz,1),'eniz, Pin=18kW',...
    d2(plasma_t.nu_eniz,2),'eniz, Pin=36kW',...
    d2(plasma_t.nu_eniz,3),'eniz, Pin=55kW',...
    d2(plasma_t.nu_eip,1),'eip, Pin=18kW',...
    d2(plasma_t.nu_eip,2),'eip, Pin=36kW',...
    d2(plasma_t.nu_eip,3),'eip, Pin=55kW',...
    '\nu_m','plot');

h_fig=plot_nY(d2(plasma_t.p,1),'p [Pa]',...
    d2(plasma_t.sigma,1),'\sigma, Pin=18kW',...
    d2(plasma_t.sigma,2),'\sigma, Pin=36kW',...
    d2(plasma_t.sigma,3),'\sigma, Pin=55kW',...
    'sigma [s^{-1}]','plot');
h_fig=plot_nY(d2(plasma_t.p,1),'p [Pa]',...
    d2(plasma_t.eps_r,1),'\epsilon_r, Pin=18kW',...
    d2(plasma_t.eps_r,2),'\epsilon_r, Pin=36kW',...
    d2(plasma_t.eps_r,3),'\epsilon_r, Pin=55kW',...
    '\epsilon_r [s^{-1}]','plot');

h_fig=plot_nY(d2(plasma_t.p,1),'p [Pa]',...
    d2(plasma_t.skin_depth./plasma_t.r,1),'skindepth/r, Pin=18kW',...
    d2(plasma_t.skin_depth./plasma_t.r,2),'skindepth/r, Pin=36kW',...
    d2(plasma_t.skin_depth./plasma_t.r,3),'skindepth/r, Pin=55kW',...
    'length ratio','plot');

h_fig=plot_nY(d2(plasma_t.p,1),'p [Pa]',...
    d2(plasma_t.wavelength./plasma_t.r,1),'wavelength/r, Pin=18kW',...
    d2(plasma_t.wavelength./plasma_t.r,2),'wavelength/r, Pin=36kW',...
    d2(plasma_t.wavelength./plasma_t.r,3),'wavelength/r, Pin=55kW',...
    'length ratio','plot');
...
h_fig=plot_nY(d2(plasma_t.p,1),'p [Pa]',...
    ...
    d2(source_tj.PER,1),'tj, Pin=18kW',...
    d2(source_tj.PER,2),'tj, Pin=36kW',...
    d2(source_tj.PER,3),'tj, Pin=55kW',...
...
h_fig=plot_nY(d2(plasma_t.p,1),'p [Pa]',...
    ...
    'PER [\Omega]','plot');
hold on
experiment_err=0.075;
errorbar(d2(plasma_t.p,1),d2(experiment.PER,1),...
    -experiment_err.*d2(experiment.PER,1),experiment_err.*d2(experiment.PER,1))
...
h_fig=plot_nY(d2(plasma_t.p,1),'p [Pa]',...
    d2(experiment.PER+input.external.Rmetal,1),'subtractive, Pin=18kW',...
    d2(experiment.PER+input.external.Rmetal,2),'subtractive, Pin=36kW',...
    d2(experiment.PER+input.external.Rmetal,3),'subtractive, Pin=55kW',...
    d2(fem.PER+fem.Rmetal,1),'fem, Pin=18kW',...
    d2(fem.PER+fem.Rmetal,2),'fem, Pin=36kW',...
    d2(fem.PER+fem.Rmetal,3),'fem, Pin=55kW',...
    'Rs [\Omega]','plot');

h_fig=plot_nY(d2(plasma_t.p,1),'p [Pa]',...
    d2(fem.Rmetal,1),'fem, Pin=18kW',...
    d2(fem.Rmetal,2),'fem, Pin=36kW',...
    d2(fem.Rmetal,3),'fem, Pin=55kW',...
    'Rmetal [\Omega]','plot');

h_fig=plot_nY(d2(plasma_t.p,1),'p [Pa]',...
    d2(fem.Ls,1),'fem, Pin=18kW',...
    d2(fem.Ls,2),'fem, Pin=36kW',...
    d2(fem.Ls,3),'fem, Pin=55kW',...
    'Ls [uH]','plot');


h_fig=plot_nY(d1(plasma_t.Pin,1),'{\itP}_{in} [kW]',...
    d1(experiment.PER,2),'subtractive-0.3Pa',...
    d1(fem.PER,2),'fem-0.3Pa',...
    fem.magnetized_a(:,1),'fem-0.3Pa-m',...
    fem.slitplasma(:,1),'fem-0.3Pa-slitplasma',...
    'PER [\Omega]','semilogy');
